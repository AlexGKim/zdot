...
The ``spZline'' emission-line fits to the spectra are used to select
objects 
...
spZline fits a common $\Delta v$ for all forbidden lines while the average continuum fluxes for both doublets  are given.
For target Plate~\#2872, Fiber~\#468, at $z=0.680$, the [OIII] features are shifted to the near-infrared and are difficult to access from ground-based observations.
...
SDSS target specified by ???? Plate~\#25, Fiber~\#318 
