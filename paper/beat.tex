...
In back to back articles published in 1962, McVittie \citep{mcvittie} and 
Sandage \citep{sandage} laid out the basics of redshift drift.  Since the 
...
\begin{figure}
   \centering
  %\includegraphics[width=\columnwidth]{zrange.pdf}
...
flow (but see \citet{13071628}).  The idea behind cosmic pulsars is not 
