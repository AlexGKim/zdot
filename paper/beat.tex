...
For example, the constraint from adding the $z=2$ measurements to the $z=0.3$ 
measurements yields a figure of merit of 1658, about 14 times higher than 
the $z=0.3$ case alone. 
...
case delivers only a figure of merit of 4.7, and even the combined $z=0.3+2$ 
case gives 66, not even at ``Stage 3'' levels. We now outline some of the 
