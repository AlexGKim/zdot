...
obtain highly precise redshift measurements. We are guided by two concepts: 
...
\eric{Did you still want the following text: 
...
\eric{Center table or otherwise delete extra space} 
\label{dz:tab}}
\tablehead{
