...
\alex{Measurement of the Hubble parameter, e.g.\ through the radial 
...
\eric{Here we briefly compare this Hubble drift from the 
...
\eric{I commented out the instrument/observing conditions sentence since 
it conflicts with our concerns about long term stability.} 
...
%uncertainties. 
\textcolor{red}{By the nature of the strong lensing time delay, it may be possible 
...
$N_{\rm line,q} \approx 500$ narrow metallic spectral lines 
\citep{2008MNRAS.386.1192L} that combined are used to measure the quasar
redshift.} 
\eric{Where does 500 come from? The most I see in Liske is 225 for one 
system.} 
\textcolor{red}{  Embedded within the image spectra are not only the quasar redshift but 
...
\textcolor{red}{
The wavelength separation of the doublet lines is proportional to $(1+z)$, their cross-correlation in log-wavelength
...
\textcolor{red}{
inverse of the} 
line width and the square root of line flux, so bright, narrow lines 
are desired. 

\textcolor{red}{
SDSS3 (just as the aforementioned future surveys) has a spectrograph that does
not resolve lines as fine as those quoted in the Table~\ref{lines:tab} and velocity dispersions come
...
are modeled as a function of wavenumber $\sigma$ as
\begin{align}
...
\textcolor{red}{ 35\%.
The interferometer optics and fringe visibility has a $\approx 75\%$ efficiency, so the Conventional spectrograph
...
effective point-spread-function dominated by the pixel top-hat function.
...
\textcolor{red}
{being that the EDI creates a uniform spatial frequency for all wavelengths and thus has an extremely wide bandwidth, whereas the ED-SHS creates a diamond-like fringe pattern whose spatial frequency varies rapidly around specific wavelength limiting the practical bandwidth significantly.}
