...
even if such a cosmic probe happens not practically reach the same 
...
%in agreement with Fig.~\ref{fig:sens}. The 
...
while still focusing the sensitivity at a particular redshift z; see below 
...
as active galactic nuclei, for example. See \citet{2008PhLB..660...81A,2008PhRvD..77b1301U} for 
...
\alex{The measurement of the Hubble parameter at different times is a kinematic
probe of the acceleration of the Universe: just as redshift drift gives the difference
between $\dot{a}$ at two different cosmic times and whose sign directly indicates
acceleration or deceleration, the difference in the Hubble parameter $\dot{a}/a$
at two different times gives an alternative measure of the sign of the acceleration
and a different functional dependence on the cosmological parameters.
The radial (redshift) extent of the BAO feature for a given redshift gives the Hubble parameter when the light was emitted;
obtaining radial BAO at different redshifts accesses acceleration.}
...
\eric{We highlight here how the 
