...
\textcolor{red}
{
This directness means that even if such a cosmic probe cannot practically reach the 
accuracy on dynamical cosmological-model parameters compared to the more established
...
then the drift will change to positive
\textcolor{red}{
see Eqn.~\ref{zdot:eqn} for the exact condition)}.  Thus the hope is to map out the 
...
sources, quasars and active galactic nuclei are natural targets.  The
use of the Lyman-$\alpha$ forest is constrained to systems with $<5\arcsec$ 
...
wavelengths) 
and so the redshifts
\textcolor{red}{
for a geodesic will be
...
and references therein).  Here, however, 
\textcolor{red}{
the Universe is giving us for free a time baseline for 
the redshift drift of the individual source. 
}
...
\textcolor{red}{
Although the time delay for each gas cloud will not be directly measured, they
can be constrained using the delay
...
signals within each image spectrum.
\textcolor{red}{
The $N_{\rm line,q} \approx 500$ metallic spectral lines 
in the quasar \citep{2008MNRAS.386.1192L}} help to improve the 
